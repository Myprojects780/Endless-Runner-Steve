...
canJump=true
score=0
score2=createSprite(width-100,height-590)
score2.addAnimation("score",diamondImg)
score2.scale=0.2
obstaclesGrp2=createGroup()
score3=0
score4=createSprite(width-100,height-560)
score4.addAnimation("score",GoldImg)
score4.scale=0.1
score5=0
score6=createSprite(width-100,height-530)
score6.addAnimation("score",IronImg)
score6.scale=0.2
score7=0
score8=createSprite(width-100,height-495)
...
invisground=createSprite(width/2,height-75,width,20)
...
if (gamestate==="ALIVE"){
    ...
    spawnClouds()
    spawnPhantom()
    if(keyDown("space")&& (steve.y > height-185)&&(canJump===true)) {
        steve.velocityY = -18;
        console.log(steve.y)
    }
    if (steve.y<height-185&&(gamestate="ALIVE")){
        ground.velocityX=-11
...
fill("white")
textSize(25)
text("= "+score,width-80,height-580)
text("= "+score3,width-80,height-555)
text("= "+score5,width-80,height-530)
text("= "+score7,width-80,height-495)
if (gamestate==="DEAD"){
...
function spawnPhantom(){
 if (frameCount % 300 ===0){
    ...
    phantom.y = Math.round(random(200,260))
    phantom.velocityX=-7
